...
$(document).ready(function () {
  ...
  if (userAge >= 18) {
    ...
    // If userAge is a number less than 18, this instructs the browser to show the #younger element
  } else if (userAge < 18) {
    $("#younger").show();

    // If userAge is still a NaN, this instructs the browser to return the #error element
  } else {
    $("#error").show();
  }
});
